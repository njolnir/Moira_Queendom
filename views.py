...
class pages:
    ...
    def sp_playlist():
        ...
        embed_code = '<iframe src="https://open.spotify.com/embed/playlist/65zxFtHsH7juLMTepFiD9x?utm_source=generator" width="100%" height="640" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>'
